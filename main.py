...
def markdown_msg(tech_list):
    ...
    while x <5:
        if bool(tech_list["subBullet{}".format(x)]):
#           print (tech_list["subBullet{}".format(x)])
            message_format += ("* {}  \n".format(tech_list["subBullet{}".format(x)])) #removed  \n
...
def get_arch_info(arch):
    ...
    ea = "## *_- EA - _*\n"
    capital = "## *_- Capital - _*\n"
    promo = "## *_-Promotions - _*\n"
    proposal = "## *_- Proposals - _*\n"
    spiff = "## *_- SPIFFS - _*\n"
    combined = ""
